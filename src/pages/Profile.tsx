  ...
  return (
    <IonPage>
      ...
      <IonContent fullscreen>
        ...
        <IonCard>
          <img alt="Silhouette of mountains" id="cover_pic" onClick={toggleModal_coverpic} src="../src/img/Jalinon.5.jpg" />
          

          <IonCardHeader>
            <IonCardTitle>John Michael Jalinon</IonCardTitle>
            <IonCardSubtitle>BSIT STUDENT</IonCardSubtitle>
          </IonCardHeader>

          <IonCardContent>Hindi mahalaga ang mag wagi<br></br>Ang mahalaga ikaw ay naki bahagi</IonCardContent>
          ...
          >
            <img alt="Silhouette of mountains" id="coverpic" src="../src/img/CoverPhoto.png" />
          ...
          >
            ...
            <img alt="Silhouette of mountains" id="profpic" src="../src/img/CoverPhoto.png" />
